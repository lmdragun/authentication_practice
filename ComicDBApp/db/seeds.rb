...
wicdiv = Comic.create(name: "The Wicked + The Divine", writer: "Kieron Gillen", artist: "Jamie McKelvie", year: "2014", img_url: "https://d138hkes00e90m.cloudfront.net/release_images/TWTD_1A.jpg", user: user, user_id: user.id)
gotg = Comic.create(name: "Guardians of the Galaxy", writer: "Dan Abnett & Andy Lanning", artist: "Various", year: "2008", img_url: "http://x.annihil.us/u/prod/marvel/i/mg/3/00/517ad45130d84/portrait_incredible.jpg", user: user, user_id: user.id )
